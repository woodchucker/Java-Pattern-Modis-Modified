...
public class _01ScannerMain {
	...
	private static int richiediScelta() {
		...
		int retVal = Integer.parseInt(inputScanner.nextLine());
	...
	public static void addPerson(Persona[] persone, int count) {
		...
		persone[count].setName(inputScanner.nextLine());
		System.out.println("inserisci età");
		persone[count].setEta(Integer.parseInt(inputScanner.nextLine()));
	}
